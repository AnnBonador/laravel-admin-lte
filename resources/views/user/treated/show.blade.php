                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="text" name="teeth" value="{{ $treated->teeth }}" class="form-control"
                                        placeholder="teeth">
                                    @if ($errors->has('teeth'))
                                ...
                                <div class="form-group col-sm-6">
                                    <label for="">Fee</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" name="fee" value="{{ $treated->fee }}" class="form-control"
                                        onkeypress="return isNumber(event)" placeholder="Enter fee">
                                    @if ($errors->has('fee'))
                ...
                <div class="col-md-4">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            Details
                            <a href="{{ route('user.treated.index') }}" class="btn btn-sm btn-danger float-right"> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <table class="table m-0">
                                        ...
                                        <tbody>
                                            @foreach ($transact as $data)
                                                <tr>
                                                    <td><a href="pages/examples/invoice.html">{{ $data->reference_no }}</a>
                                                    </td>
                                                    <td>{{ $data->amount }}</td>
