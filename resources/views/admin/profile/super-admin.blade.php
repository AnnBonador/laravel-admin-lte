                ...
                <div class="col-md-9">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.admin.profile', Auth::id()) }}" method="POST"
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input class="custom-control-input" type="radio" value="Others" id="others"
                                                name="gender" {{ $user->gender == 'Others' ? 'checked' : '' }}>
                            ...
                            <div class="text-center">
                                @if (!empty($user->image))
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset('uploads/admin/' . $user->image) }}" alt="User profile picture">
                                @else
                                    <img class="profile-user-img img-fluid img-circle"
