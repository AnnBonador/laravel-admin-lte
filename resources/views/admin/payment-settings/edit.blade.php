            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">Edit Paypal
                            <a href="{{ route('paypal.index') }}" class="btn btn-sm btn-danger float-right"> Back</a>
                        </div>
                        <div class="card-body">
                            @include('layouts.partials.messages')
                            <form action="{{ route('paypal.update', $paypal->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                @hasanyrole('Clinic Admin|Receptionist')
                                    <input type="hidden" name="clinic_id" value="{{  $paypal->clinic_id }}">
                                @endrole
                                <div class="row mb-2">
                                    @role('Super-Admin')
                                    ...
                                    <div class="form-group col-sm-5">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" name="username" value="{{ $paypal->username }}"
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="password" name="password" value="{{ $paypal->password }}"
                                    ...
                                    <div class="form-group col-sm-8">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" name="secret" value="{{ $paypal->secret }}"
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" name="currency" value="{{ $paypal->currency }}"
